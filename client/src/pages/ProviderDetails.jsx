            ...
            <Card sx={{ p: 2, boxShadow: 3 }}>
                <CardContent>
                    ...
                    <Grid container spacing={2} sx={{ mb: 3 }}>
                        <Grid item xs={6}><strong>First Name:</strong> {details.firstName}</Grid>
                        <Grid item xs={6}><strong>Last Name:</strong> {details.lastName}</Grid>
                        ...
                        <Grid item xs={6}><strong>Company Address:</strong> {details.companyAddress}</Grid>
